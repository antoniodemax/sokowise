...
import { authApi, type ChangePasswordRequest, type LoginRequest, type RegisterRequest } from './api'
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<AuthContextValue>(
    () => ({ session, restoring, login, register, changePassword, logout, logoutAll }),
    [session, restoring, login, register, changePassword, logout, logoutAll],
  )
